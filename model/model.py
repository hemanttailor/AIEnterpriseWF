...
def _model_train(df,tag,test=False):
    ...
    if test:
        saved_model = os.path.join(".\saved-models",
...
def model_load(prefix='sl',data_dir=None,training=True):
    ...
    models = [f for f in os.listdir(".\saved-models") if re.search(prefix,f)]
    ...
    all_models = {}
    for model in models:
        all_models[re.split("-",model)[1]] = joblib.load(os.path.join(".","saved-models",model))
...
if __name__ == "__main__":
    ...
    print("Model: Initializing Test Procedure")
    ## train the model
    ...
    print("Model: Models loaded: ",",".join(all_models.keys()))

    print("Model: Performing Prediction")
    ## test predict
    country='all'
    year='2018'
    month='01'
    ...
    print("Model: Result for \"all\",\"2018-01-05\" -> {}", result)
